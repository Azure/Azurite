...
- Updated the lockfile-resolved `@types/node` dev dependency from 26.2.0 to 26.6.1 for current Node.js type declarations; added `tests/common/bufferStream.test.ts` covering `BufferStream` chunking.
