...
- Updated the lockfile-resolved `@azure/identity` dev dependency from 4.13.2 to 4.13.3 (declared range remains `^4.2.1`), which also moves transitive `@azure/msal-node` from 5.5.0 to 6.0.1; no Azurite code changes were needed.
