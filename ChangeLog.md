...
- Updated lockfile-resolved `mysql2` from 3.24.2 to 3.24.3 to fix `PoolCluster` node events emitting a string `nodeId` typing; Azurite does not use `PoolCluster`, so this is a low-impact typings fix.
