...
- Bumped the `serialize-javascript` npm `overrides` entry (transitive dependency via `mocha`) from 7.0.3 to 7.0.5, remediating the CPU exhaustion denial of service with crafted array-like objects (GHSA-qj8w-gfj5-8c6v / CVE-2026-34043).
