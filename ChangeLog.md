...
- Fixed Blob GET and HEAD requests for nonexistent blobs with `If-Match` returning `BlobNotFound` instead of `ConditionNotMet`, matching Azure Storage. (issue #2751)
