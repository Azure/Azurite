...
- Bumped `express` from 4.16.4 to 5.2.1, updated `@types/express` to 5.0.6, and added `@types/mime` as an explicit dev dependency because it is no longer provided transitively by the Express type packages.
