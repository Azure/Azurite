...
- Updated the lockfile-resolved `@types/node` dev dependency from 26.4.0 to 26.4.1 for minor Node.js type declaration fixes; no source code changes were required.
