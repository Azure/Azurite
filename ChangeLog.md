...
- Bumped `globals` dev dependency from 17.9.0 to 17.11.0. Used only in `eslint.config.js` to provide `globals.node` for the flat ESLint config; verified with `npm run lint`, no code changes required.
