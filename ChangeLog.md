...
- Updated lockfile-resolved `mocha` from 12.0.0-rc.6 to 12.0.0 for stable CLI argument parsing; added regression coverage for quoted grep patterns and negative timeout values.
