...
- Updated lockfile-resolved `fast-uri` from 3.1.5 to 3.1.7 to prevent URI authority and host confusion; added malformed-port regression coverage for its Ajv development-tool path.
