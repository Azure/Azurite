...
- Updated lockfile-resolved `axios` from 1.19.0 to 1.20.0 for hardened runtime option handling; added coverage for staging a block from an Axios-issued request.
