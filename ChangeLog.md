...
- Updated `github/codeql-action` from 4.37.9 to 4.38.0 for CodeQL scanning maintenance; added package-scripts coverage to keep the CodeQL workflow's init, autobuild, and analyze steps pinned together.
