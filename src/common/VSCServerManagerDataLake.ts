...
import { DEFAULT_DATA_LAKE_LISTENING_PORT, DEFAULT_DATA_LAKE_SERVER_HOST_NAME } from "../dfs/utils/constants";
...
export default class VSCServerManagerDataLake extends VSCServerManagerBase {
  ...
  private async getConfiguration(): Promise<BlobConfiguration> {
    ...
    const config = new BlobConfiguration(
      env.datalakeHost() || DEFAULT_DATA_LAKE_SERVER_HOST_NAME,
      env.datalakePort() || DEFAULT_DATA_LAKE_LISTENING_PORT,
