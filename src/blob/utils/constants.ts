...
export const VERSION = "3.1.2-preview";
...
export const DEFAULT_BLOB_DB_PATH = "__azurite_db_blob__.json";
export const DEFAULT_EXTENT_DB_PATH = "__azurite_db_blob__.json";
