...
export default class BlobHandler extends BaseHandler implements IBlobHandler {
  ...
  public async getProperties(
    ...
    const response: Models.BlobGetPropertiesResponse = againstMetadata
      ...
      : {
        ...
        // x-ms-is-current-version is only returned for the current version, it is
        // absent when a previous version is addressed.
        isCurrentVersion:
          res.isCurrentVersion === true ? true : undefined,
      };
  ...
  private async downloadBlockBlobOrAppendBlob(
    ...
    const response: Models.BlobDownloadResponse = {
      ...
      isCurrentVersion: blob.isCurrentVersion === true ? true : undefined,
    };
