import IAuthenticationContext from "../../blob/authentication/IAuthenticationContext";
import Context from "../../blob/generated/Context";

export default class DataLakeContext
  extends Context
  implements IAuthenticationContext
{
  ...
  public get originalBlob(): string | undefined {
    return this.context.originalBlob;
  }

  public set originalBlob(originalBlob: string | undefined) {
    this.context.originalBlob = originalBlob;
  }
  ...
  public set disableProductStyleUrl(
    disableProductStyleUrl: boolean | undefined
  ) {
