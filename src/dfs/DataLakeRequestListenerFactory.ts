...
import PageBlobRangesManager from "../blob/handlers/PageBlobRangesManager";
...
import MiddlewareFactory from "../blob/generated/MiddlewareFactory";
import AppendBlobHandler from "../blob/handlers/AppendBlobHandler";
import BlobHandler from "../blob/handlers/BlobHandler";
import BlockBlobHandler from "../blob/handlers/BlockBlobHandler";
import ContainerHandler from "../blob/handlers/ContainerHandler";
import PageBlobHandler from "../blob/handlers/PageBlobHandler";
/**
 ...
 *
 * @export
 * @class DataLakeRequestListenerFactory
 * @implements {IRequestListenerFactory}
 */
export default class DataLakeRequestListenerFactory
  implements IRequestListenerFactory
{
  public constructor(
  ...
  public createRequestListener(): RequestListener {
    ...
    app.use(
      createStorageBlobContextMiddleware(
