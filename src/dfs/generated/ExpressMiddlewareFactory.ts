...
import BlobContext from '../../blob/generated/Context';
...
import BlobExpressMiddlewareFactory from '../../blob/generated/ExpressMiddlewareFactory';
 ...
 */
export default class ExpressMiddlewareFactory extends BlobExpressMiddlewareFactory {
  /**
  ...
  public constructor(
    logger: ILogger,
    private readonly dfsContextPath: string = "default_context"
  ) {
    super(logger, dfsContextPath);
  }
  ...
  public createDispatchMiddleware(): RequestHandler {
    return (req: Request, res: Response, next: NextFunction) => {
      ...
      dispatchMiddleware(
        new Context(res.locals, this.dfsContextPath, request, response),
        request,
        next,
        this.logger
      );
   ...
   * @memberof MiddlewareFactory
   */
  public createHandlerMiddleware(handlers: any): RequestHandler {
    ...
    return (req: Request, res: Response, next: NextFunction) => {
      ...
      handlerMiddlewareFactory.createHandlerMiddleware()(
        new Context(res.locals, this.dfsContextPath, request, response) as BlobContext,
        next
      );
    };
  }
