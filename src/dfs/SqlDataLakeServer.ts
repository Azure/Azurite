 ...
 * @class Server
 */
export default class SqlDataLakeServer extends ServerBase {
   ...
   * @memberof Server
   */
  constructor(configuration: SqlDataLakeConfiguration) {
    ...
    const metadataStore: IDataLakeMetadataStore = new SqlDataLakeMetadataStore(
