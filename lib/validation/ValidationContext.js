...
class ValidationContext {
    ...
    run(valModule, moduleOptions, skip) {
        ...
        valModule.validate({ 
            request: moduleOptions.request || this.request, 
            containerProxy: moduleOptions.containerProxy || this.containerProxy, 
            blobProxy: moduleOptions.blobProxy || this.blobProxy, 
