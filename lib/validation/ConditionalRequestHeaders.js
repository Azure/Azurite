...
class ConditionalRequestHeaders {
    ...
    validate(options) {
        const requestBlob = options.requestBlob,
            ...
            ETagVal = updateItem.httpProps['ETag'].toString(),
        ...
        const ifModifiedSince = ifModifiedSinceVal >= lastModifiedVal,
            ifUnmodifiedSince = ifUnmodifiedSinceVal < lastModifiedVal,
        ...
        switch (options.operationType) {
            ...
            case 'write':
                if (ifMatchVal !== undefined && !ifMatch ||
                    ...
                    ifModifiedSinceVal !== undefined && !ifModifiedSinceVal) {
                    throw new AError(ErrorCodes.ConditionNotMetWrite); // 412
                }
                break;
        }
