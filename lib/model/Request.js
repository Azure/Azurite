...
class Request {
    constructor(containerName, blobName, httpHeaders, rawHeaders, body) {
        ...
        this._initHttpProps(httpHeaders);
    }
    ...
    generateStorageEntity() {
        // TODO: generates initial storage entity for persisting in LokiJS
        // might differ depending on whether it is a container or a blob 
    ...
    _initHttpProps(httpHeaders) {
        ...
        this.httpProps[N.BLOB_PUBLIC_ACCESS] = httpHeader['x-ms-blob-public-access'];
