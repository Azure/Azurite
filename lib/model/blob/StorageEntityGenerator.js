...
class StorageEntityGenerator {
  ...
  clone(o) {
    ...
    copy.name = o.name;
    copy.etag = o.etag;
    if (o.entityType !== StorageEntityType.Container) {
      ...
      if (o.entityType === StorageEntityType.AppendBlob) {
        copy[N.BLOB_COMMITTED_BLOCK_COUNT] = o[N.BLOB_COMMITTED_BLOCK_COUNT];
      }
      if (o.entityType === StorageEntityType.BlockBlob && o.blockId !== null) {
        copy.blockId = o.blockId;
        copy.parent = o.parent;
      }
      if (o.entityType === StorageEntityType.PageBlob) {
        copy.size = o.size;
