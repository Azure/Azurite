...
class Blob extends StorageItem {
    ...
    _addProps(httpHeader) {
        if (this.blobType === BlobTypes.AppendBlob) {
            ...
            this.httpProps['x-ms-blob-condition-maxsize'] = parseInt(httpHeader['x-ms-blob-condition-maxsize']) || undefined; 
            this.httpProps['x-ms-blob-condition-appendpos'] = parseInt(httpHeader['x-ms-blob-condition-appendpos']) || undefined; 
        }
