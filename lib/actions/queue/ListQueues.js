...
class ListQueues {
    ...
    process(request, res) {
        ...
        const { queues, nextMarker } = QueueManager.listQueues({ prefix: query.prefix, marker: query.marker, maxresults: query.maxresults });
        ...
        xmlModel.Prefix = query.prefix ? query.prefix : '';
        xmlModel.Marker = query.marker ? query.marker : '';
        xmlModel.MaxResults = query.maxresults ? query.maxresults : '';
