...
class StorageManager {
    ...
    getBlobMetadata(request) {
        ...
        const res = this._getCollectionAndBlob(request.containerName, request.publicName()),
            blobProxy = res.blobProxy;
    ...
    setContainerMetadata(request) {
        ...
        const res = this._getCollectionAndContainer(request.containerName),
            containerProxy = res.containerProxy,
            coll = res.coll;
            ...
            return new BbPromise((resolve, reject) => {
                writeStream
                    ...
                    .on('finish', () => {
                        ...
                        // TODO: Replace with proxy.original.sequenceNumber
    ...
    _getCollectionAndContainer(containerName) {
        ...
        return {
            coll: coll,
            container: new ContainerProxy(result[0])
        };
    }
