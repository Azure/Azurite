...
class StorageManager {
    ...
    snapshotBlob(request) {
        const { coll, blobProxy } = this._getCollectionAndBlob(request.containerName, request.blobName);
        const snapshotBlobProxy = new BlobProxy(StorageEntityGenerator.clone(blobProxy.original), request.containerName);
        ...
        snapshotBlobProxy.original.name = request.publicName();
