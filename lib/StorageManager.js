...
class StorageManager {
    ...
    leaseContainer(request) {
        const leaseAction = request.httpProps['x-ms-lease-action'],
            proposedLeaseId = request.httpProps['x-ms-proposed-lease-id'],
            leaseId = request.httpProps['x-ms-lease-id'],
            leaseBreakPeriod = (request.httpProps['x-ms-lease-break-period']) ? parseInt(request.httpProps['x-ms-lease-break-period']) : undefined,
            leaseDuration = (request.httpProps['x-ms-lease-duration']) ? parseInt(request.httpProps['x-ms-lease-duration']) : undefined;
        ...
        switch (leaseAction) {
            case 'acquire':
                ...
                containerProxy.orginal.leaseState = 'leased';
                break;
            case 'renew':
            ...
            case 'change':
                ...
                break;
            case 'release':
                containerProxy.orginal.leaseState = 'available';
                break;
            case 'break':
                ...
                containerProxy.orginal.leaseState = 'breaking';
                break;
            default:
