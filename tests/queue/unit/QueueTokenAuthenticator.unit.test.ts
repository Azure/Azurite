...
import AuthenticationMiddlewareFactory from "../../../src/queue/middlewares/AuthenticationMiddlewareFactory";
...
import { DEFAULT_QUEUE_CONTEXT_PATH, HeaderConstants } from "../../../src/queue/utils/constants";
...
describe("QueueTokenAuthenticator Unit Tests @loki", () => {
  ...
  it("denies the request end-to-end through AuthenticationMiddlewareFactory when OAuth level is unknown", async () => {
    ...
    const seedContext = new QueueStorageContext(
      holder,
    ...
    const expressReq: any = {
      ...
      url: "/",
      protocol: "https",
      hostname: "devstoreaccount1.queue.core.windows.net",
      path: "/",
      body: undefined,
      headers: {},
      rawHeaders: [],
