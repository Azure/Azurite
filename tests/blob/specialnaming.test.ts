...
describe("SpecialNaming", () => {
  ...
  const productionStyleHostNameForSecondary = "devstoreaccount1-secondary.blob.localhost"; // Use hosts file to make this resolve
  ...
  it(`Should work with production style URL for secondary when ${productionStyleHostNameForSecondary} is resolvable`, async () => {
