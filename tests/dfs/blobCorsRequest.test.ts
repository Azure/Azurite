...
import OPTIONSRequestPolicyFactory from "../blob/RequestPolicy/OPTIONSRequestPolicyFactory";
import OriginPolicyFactory from "../blob/RequestPolicy/OriginPolicyFactory";
...
describe("Blob Cors requests test", () => {
  ...
  it("OPTIONS request without cors rules in server should be fail @loki @sql", async () => {
    ...
    const serviceClientForOptions = new DataLakeServiceClient(
      baseURL,
      pipeline
    );
  ...
  it("OPTIONS request should not work without matching cors rules @loki @sql", async () => {
    ...
    let serviceClientForOptions = new DataLakeServiceClient(baseURL, pipeline);
    ...
    serviceClientForOptions = new DataLakeServiceClient(baseURL, pipeline);
  ...
  it("Response of request to service without cors rules should not contains cors info @loki @sql", async () => {
    ...
    const serviceClientWithOrigin = new DataLakeServiceClient(
      baseURL,
      pipeline
    );
  ...
  it("Requests with error response should apply for CORS @loki @sql", async () => {
    ...
    const containerClientWithOrigin =
      serviceClientWithOrigin.getFileSystemClient("notexistcontainer");
