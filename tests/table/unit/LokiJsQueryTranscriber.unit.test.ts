  ...
  it("correctly transcribes a query for a value of type string", async () => {
    ...
    const testArray = [
      ...
      },
      {
        ...
        expectedQuery:
          "return ( ( 'C:\\\\Windows\\\\System32' === item.properties.myString ) )"
      },
      {
        originalQuery: "( 'I am a string with `backticks`' eq myString )",
        expectedQuery:
          "return ( ( 'I am a string with `backticks`' === item.properties.myString ) )"
      },
      {
        originalQuery: "( 'I am a string with ${an attempted interpolation escape}' eq myString )",
        expectedQuery:
          "return ( ( 'I am a string with ${an attempted interpolation escape}' === item.properties.myString ) )"
      }
    ];
